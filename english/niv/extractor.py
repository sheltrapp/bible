...
xml_file_path = './niv.xml'  # Use the correct path for the XML file in the current environment
db_path = 'niv_bible.db'
...
for bible in root.findall('testament'):  # Updated to find 'testament' instead of 'bible'
    for book in bible.findall('book'):  # Use the correct root node
        ...
        cursor.execute('INSERT INTO Books (name, book_abv, int_book_abv) VALUES (?, ?, ?)', (book_name, book_abv, book_abv))
